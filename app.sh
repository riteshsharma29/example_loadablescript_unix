...
# Below File will be created temperorily containing 3 letter ID, Currents month,Current year,PArt Number,Version Number.
echo "MTH="$1 >> $SOURCEPATH_OUTPUT/info.ini
echo "YR="$2 >> $SOURCEPATH_OUTPUT/info.ini
echo "PN="$3 >> $SOURCEPATH_OUTPUT/info.ini
echo "VR="$4 >> $SOURCEPATH_OUTPUT/info.ini
